...
- `reset-local-dev.js` is the complete local-dev reset entry: it verifies Hardhat Local is reachable, recreates the `mermer` and `cardforge` databases, then redeploys contracts and generated manifests.
