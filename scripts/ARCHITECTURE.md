...
- `merchant-project-loop.js` proves the merchant-platform loop end to end: project creation, one-time API key, standalone CardForge checkout, local payment projection, signed webhook, and dashboard stats.
