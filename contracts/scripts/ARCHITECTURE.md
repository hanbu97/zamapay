...
- `deploy-contracts.js` deploys `PrivateCheckoutSettlement`, `ConfidentialUSDMock`, and the subscription contracts; it does not deploy transparent invoice settlement or public-testnet manifests.
