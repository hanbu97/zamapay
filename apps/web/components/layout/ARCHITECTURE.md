...
|-- AppSidebar.tsx # Session-aware account/project/demo shadcn Sidebar navigation with home brand link
...
- Anonymous chrome exposes only login except for the hardcoded public demo project, which gets read-only project tabs without an account-projects link.
