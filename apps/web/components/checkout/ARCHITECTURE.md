...
- Checkout client code owns only browser-bound buyer actions: wallet chain switching, local encrypted input creation, and one direct buyer transaction submission.
