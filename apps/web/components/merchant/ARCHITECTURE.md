...
- `PaymentProjectWithdraw` owns the chain-specific withdraw split: local-dev keeps the server submitter shim, while Sepolia encrypts in-browser and submits directly with the merchant wallet.
