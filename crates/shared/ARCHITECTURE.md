...
- Checkout and invoice DTOs carry amount in minor units, optional chain invoice id, transaction hash, and finality depth because private checkout evidence is projected into the Rust read model.
