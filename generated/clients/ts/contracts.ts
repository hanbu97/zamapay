export const contractNames = ['MerchantRegistry', 'ConfidentialUSDMock', 'SubscriptionPass', 'PrivateSubscriptionRegistry', 'PrivateCheckoutSettlement', 'EvmCheckoutSettlement', 'Permit2'] as const
...
export const evmCheckoutSettlementAbi = [
  {
    "inputs": [
      {
        "internalType": "address",
