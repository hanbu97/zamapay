export const contractNames = ['MerchantRegistry', 'ConfidentialUSDMock', 'SubscriptionPass', 'PrivateSubscriptionRegistry', 'ConfidentialInvoiceSettlement', 'MockConfidentialPaymentRail', 'PrivateCheckoutSettlement'] as const
