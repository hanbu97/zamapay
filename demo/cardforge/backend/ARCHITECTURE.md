...
|   |-- main.rs       # Axum routes, Mermer Pay bridge, webhook verification, and orchestration
...
- `CARDFORGE_DATABASE_URL` is required and points at a CardForge-owned Postgres database, separate from the Mermer Pay platform database.
