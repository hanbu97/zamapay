...
- `lib/local-confidential-wallet.ts` reads and claims `ConfidentialUSDMock` directly through Hardhat/FHEVM mock RPC; the backend does not project wallet balances.
