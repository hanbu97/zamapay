...
|   |-- storage/            # In-memory auth plus optional file-backed portal read models
...
- Remaining production hardening is a real database, automated indexer/worker runtime, and public-network deployment evidence.
